...
<div class="page-content-wrapper" data-bind="vieworder-active-page-link">
    ...
    <div class="page-content">
        ...
        <h1 class="page-title"> This is Your Order  <?=$this->session->userdata('name'); ?> </h1> <a style="float: right;" href="<?= base_url('delete_copyorder/'.$orderitem) ?>" class="btn btn-success"> <i class="fa fa-arrow-left"></i> Back</a>
            ...
            <div class="col-lg-12 ">
                ...
                <form action="<?= base_url('updateordermaster/'.$orderitem) ?>" id="new_order_form" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="mian_order_id" id="main_order_id" value="<?= $orderitem ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-1">
                                            ...
                                            <button type="button" name="additems" id="add_items_edit"
                                                class="btn btn-success copy_items_edit item-button"
                        ...
                        <div class="portlet-body">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 html-content" style="margin-top: 10px;">

                                        <?php $this->load->view('dashboard/edit_order_html'); ?>
...
<?php if($this->session->userdata('is_admin') == 1 || $contract == 'yes') { ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-check">
                                <!-- <input class="form-check-input" type="checkbox" id="defaultCheck1" name="contact_chk" value="1"  <?php  if($order[0]['contact_chk'] == 1) { echo "checked='checked'";} ?>> -->
                                <input class="form-check-input" type="checkbox" id="defaultCheck1" name="contact_chk" value="1"  <?php  //if($order[0]['contact_chk'] == 1) { echo "checked='checked'";} ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-check attrny-checkbox" style="padding-left: 10px;">
                                ...
                                <!-- <input class="form-check-input" type="checkbox" id="defaultCheck2" name="attrny_chk" value="1"  <?php  if($order[0]['attrny_chk'] == 1) { echo "checked='checked'";} ?>> -->
                                <input class="form-check-input" type="checkbox" id="defaultCheck2" name="attrny_chk" value="1"  <?php  //if($order[0]['attrny_chk'] == 1) { echo "checked='checked'";} ?>>
...
<?php } ?>
 ...
 <!-- /.modal -->
            <div class="modal fade" id="small_copy" tabindex="-1" role="small" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body small_copy_edit"> </div>
                        <div class="modal-footer">
