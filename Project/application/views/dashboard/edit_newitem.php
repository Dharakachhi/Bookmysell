            ...
            <div class="portlet box green">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <label>Item Name</label>
                                 <select class="form-control" name="edit_item_select" id="edit_item_select_popup">
                                    ...
                                    <!-- <option value="Entire-Location" <?php echo ($items->item_name == 'Entire-Location')?'selected':''?> >Entire Location </option> -->
                                    <option value="Barley"<?php echo ($items->item_name == 'Barley')?'selected':''?> >Barley</option>
                                    <option value="Beer" <?php echo ($items->item_name == 'Beer')?'selected':''?> >Beer</option>
                                    <option value="Cake-Mix" <?php echo ($items->item_name == 'Cake-Mix')?'selected':''?> >Cake Mix</option>
                                ...
                                <?php  } ?>
                                <!-- <input type="text" name="edit_item_name" value="<?= $items->item_name ?>" id="edit_item_name" class="form-control" > -->
                        ...
                        <div class="row">
                            ...
                            <div class="gallery">
                                ...
                                <div class="single">
                                    ...
                                    <input type="button" class="removeImage12" value="x" class="btn-rmv1" data-imageid="<?php echo $img['img_id']; ?>" data-imagename = "<?= $img['img_name']?>"/>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="form-group  col-md-4">
                        ...
                        <input type="button" id="edit_copy" name="edit_submit" value="Submit " class="btn btn-info edit_copy">
