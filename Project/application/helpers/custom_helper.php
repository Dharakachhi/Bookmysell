 ...
 *  @return object
 */
 static function sigJsonToImage ($json,$filepath, $options = array()) {
  $defaultOptions = array(
    'imageSize' => array(420, 120)
  ...
  foreach ($json as $v)
    CUSTOM::drawThickLine($img, $v->lx * $options['drawMultiplier'], $v->ly * $options['drawMultiplier'], $v->mx * $options['drawMultiplier'], $v->my * $options['drawMultiplier'], $pen, $options['penWidth'] * ($options['drawMultiplier'] / 2));
 ...
 *  @return void
 */
static function drawThickLine ($img, $startX, $startY, $endX, $endY, $colour, $thickness) {
